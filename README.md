...
只要套用 LangGPT 提供的指令模板，任何人都能轻松编写高质量 prompt。上面的小红书 prompt 就是通过用 LangGPT 的 Role 模板设计的。

ChatGPT 很擅长角色扮演，只要提供角色说明，角色行为，技能等描述，就能做出很符合角色的行为。因此 LangGPT 提出了一套角色设计方法，提供了一套角色设计模板。本着简单简洁的原则，提供的模板和规则都很简单，几分钟应该就能轻松上手。
