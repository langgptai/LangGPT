...
- **[哑铃社会](Docs/哑铃社会.md)** — AI 正在把纺锤形社会压成哑铃型：中间空了，真正的分水岭是你有没有一个"非得是我"的东西
- **[思考与河床](Docs/思考与河床.md)** — AI 是第一条被设计而非冲刷出来的河床：人类历史上第一种让被影响者感到自主的影响机制
- **[经历论](Docs/经历论.md)** — 人是经历的总和：不可逆、不可转让、不可外包给 AI 的东西，才是那个独一无二的"你"
- **[认知外包](Docs/认知外包.md)** — 记忆不是存储，理解发生在大脑处理答案的过程里：可以外包的是思考的执行，不能外包的是你还没有参照系的那次相遇——参考经过你，答案穿过你
- **[文字思考和数学思考](Docs/文字思考和数学思考.md)** — 三种思考方式是嵌套的投影：大模型在高维连续空间里漂，文字把它坍缩成离散序列，数学再把它锁进公理系统——越精确覆盖越窄，而思维永远溢出描述它的东西
- **[去除AI味儿](Docs/去除AI味儿.md)** — AI 味儿的本质是用语言的姿态替代内容和判断：元评论、防御性铺垫、例子堆叠、对称强迫症、结尾升华——一段可直接复用的提示词，以及删完之后还能不能站住的检验
- **[语言层差和行业语言](Docs/语言层差和行业语言.md)** — 你住在现象层，AI 的高质量知识住在本质层：说"要好看"得到平庸，说"建立视觉层级"得到方案——不必先学会行业语言，让 AI 翻译，在翻译中学习，真正要练的只是察觉自己正在用现象语言的那一刻
- **[语言控制学](Docs/语言控制学.md)** — 把提示词工程建成公理化理论：五条公理、30 个定义、29 条定理——提示是约束信号，作用是收缩模型的可能性空间；控制力有上界，反馈会收敛也会病变，多目标终会撞上帕累托前沿——控制的瓶颈从来不在模型那一侧，而在你能否把模糊意图翻译为精确信号
